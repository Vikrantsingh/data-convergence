...
<center>
 <form name="form1" method="post" action="">
  <table width="800" border="0">
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#FFFF99"><label>
        <select name="department" id="department" onchange="loadDataset(this.value)" multiple>
    ...
    <tr>
      ...
      <td bgcolor="#FFCC66"><select name="filter1">
        <option value="=">=</option>
        <option value="&gt;">&gt;</option>
        <option value="&lt;">&lt;</option>
            </select>
    ...
    <tr>
      ...
      <td bgcolor="#FFCC66"><input type="text" id="start" name="start" value="0" /> </td>
    </tr>
     <tr>
      <td bgcolor="#FFCC66">&nbsp;</td>
      <td bgcolor="#FFCC66">Limit:</td>
      <td bgcolor="#FFCC66"><input type="text" id="limit" name="limit" value="1"/> </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><label>
  ...
  <h4>Query Statement is:</h4><textarea id="query" class="normal" name="query"   readonly ></textarea>
  <br/>
